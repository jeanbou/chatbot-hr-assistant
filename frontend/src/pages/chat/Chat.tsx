...
import Contoso from "../../assets/SwordMS.svg";
                    ...
                    <div className={styles.chatContainer}>
                        {!messages || messages.length < 1 ? (
                            <Stack className={styles.chatEmptyState}>
                                ...
                                <h2 className={styles.chatEmptyStateSubtitle}>This General Sword Assistant chatbot is configured to answer your questions.</h2>
                            </Stack>
                        ) : (
